...
CREATE TABLE `actors_and_others_persons` (
  ...
  `persons_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `persons_type_id` bigint unsigned NOT NULL,
  `persons_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `actors_and_others_persons_ibfk_2` FOREIGN KEY (`persons_type_id`) REFERENCES `type_persons` (`id`)
...
--
-- Dumping data for table `command_film`
--

LOCK TABLES `command_film` WRITE;
/*!40000 ALTER TABLE `command_film` DISABLE KEYS */;
INSERT INTO `command_film` VALUES (1,1,2),(2,1,3),(3,1,2),(4,3,3),(5,5,5),(6,2,6),(7,1,1),(8,4,1),(9,5,2),(10,6,4);
/*!40000 ALTER TABLE `command_film` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `media` VALUES (1,'et','Nihil est placeat dolor et non nam doloribus. Quod impedit eveniet provident magni. Accusantium omnis optio eos quos. Fuga quaerat non enim.',1,4,34,NULL,'1975-02-16 09:50:40','1983-11-18 22:01:36',1,_binary '\0'),(2,'distinctio','Ullam consequuntur minima et illo voluptatem non quia. Aperiam id sit et nostrum. Ut id nam voluptatem sapiente cumque modi.',2,1,259,NULL,'1976-07-22 00:43:32','1995-04-19 12:09:16',2,_binary '\0'),(3,'repellendus','Sit aliquam et quo et. Molestias quia maiores sunt labore iste et. Asperiores et quidem dolores. Aut autem et quibusdam in maxime tempora dicta accusamus.',3,3,658799,NULL,'2006-03-25 12:33:21','2006-12-03 11:01:28',3,_binary '\0'),(4,'odio','Ipsum odit in fugiat rem voluptatem. Quasi animi et officiis consequatur aut. Ut nam quae accusamus voluptatum at consectetur eius a. Odio molestiae voluptatem vero et.',4,2,0,NULL,'1991-02-23 01:35:07','2006-01-08 00:48:46',4,_binary '\0'),(5,'ut','Quaerat deserunt corrupti est distinctio quos et voluptatem laboriosam. Aut nihil harum rerum officia. Fugit saepe tempora veritatis ut earum quibusdam. Maxime et quasi saepe eos natus.',1,2,63529,NULL,'1988-01-01 17:28:10','2000-09-01 08:42:11',1,_binary '\0'),(6,'debitis','Omnis repellendus vel officiis rerum. Voluptatem voluptatibus labore praesentium perspiciatis asperiores eveniet et. Repellat eius non libero velit esse.',2,3,0,NULL,'1979-07-16 04:41:05','1985-08-05 08:39:04',2,_binary '\0'),(7,'ab','Vel voluptatem cumque dolorum aut enim maiores. Ipsa et illum pariatur totam voluptatem. Amet delectus facere enim sequi neque et. Omnis velit id debitis cumque. Quo velit nisi in quas beatae porro quia et.',3,4,0,NULL,'1986-10-08 19:23:27','1983-09-05 22:17:58',3,_binary '\0'),(8,'rem','Aperiam voluptatum odio ab ipsam. Impedit error perferendis rerum totam velit autem error. Fuga et deserunt laboriosam eos commodi. Totam voluptate voluptatem velit consequuntur non.',4,1,86959,NULL,'2007-10-17 11:58:05','1988-08-15 06:07:23',4,_binary '\0'),(9,'itaque','Et voluptas tempore et. Qui alias ut magnam qui temporibus voluptatem eaque. Rerum laborum hic earum dolorem sed.',1,1,79596,NULL,'2018-02-17 02:47:29','1997-06-25 00:52:09',1,_binary '\0'),(10,'voluptates','Praesentium suscipit deserunt dolor. Et illo tenetur ratione. Necessitatibus officiis corporis id vero et. Quia ab itaque quia magnam quasi velit. Nobis suscipit aliquam odio aliquam ipsa.',2,5,5,NULL,'2000-06-20 18:23:15','1979-12-11 04:11:18',2,_binary '\0');
...
CREATE TABLE `media_ratings` (
  ...
  `media_id` bigint unsigned NOT NULL,
  `rate` enum('0','1','2','3','4','5') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  UNIQUE KEY `id` (`id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `paid_subscriptions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint unsigned NOT NULL,
  `type_subscription_id` bigint unsigned NOT NULL,
  UNIQUE KEY `id` (`id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `type_persons` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `type_persons` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `type_subscription` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `type_subscription` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2021-09-07 23:19:50
